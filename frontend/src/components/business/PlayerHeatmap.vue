  ...
  <div class="w-full h-80 min-h-80 relative">
    ...
    <div class="absolute inset-0 flex items-center justify-center">
      <svg viewBox="0 0 68 105" class="w-full h-full" preserveAspectRatio="xMidYMid meet">
        ...
        <!-- Center line -->
        <line x1="0" y1="52.5" x2="68" y2="52.5" stroke="#ffffff" stroke-width="1"/>
        
        <!-- Center circle -->
        <circle cx="34" cy="52.5" r="9.15" fill="none" stroke="#ffffff" stroke-width="1"/>
        <circle cx="34" cy="52.5" r="0.5" fill="#ffffff"/>
        
        <!-- Top goal area (front) -->
        <rect x="13.84" y="0" width="40.32" height="16.5" fill="none" stroke="#ffffff" stroke-width="1"/>
        <rect x="24.84" y="0" width="18.32" height="5.5" fill="none" stroke="#ffffff" stroke-width="1"/>
        <rect x="30.34" y="-1" width="7.32" height="1" fill="#ffffff"/>
        
        <!-- Bottom goal area -->
        <rect x="13.84" y="88.5" width="40.32" height="16.5" fill="none" stroke="#ffffff" stroke-width="1"/>
        <rect x="24.84" y="99.5" width="18.32" height="5.5" fill="none" stroke="#ffffff" stroke-width="1"/>
        <rect x="30.34" y="105" width="7.32" height="1" fill="#ffffff"/>
        
        <!-- Penalty arcs -->
        <path d="M 34 16.5 A 9.15 9.15 0 0 1 24.84 16.5" fill="none" stroke="#ffffff" stroke-width="1"/>
        <path d="M 34 88.5 A 9.15 9.15 0 0 0 43.16 88.5" fill="none" stroke="#ffffff" stroke-width="1"/>
      </svg>
...
const initChart = () => {
  ...
  const option = {
    ...
    visualMap: {
      ...
      show: false,
      inRange: {
        color: ['rgba(255, 255, 128, 0.1)', 'rgba(255, 255, 128, 0.25)', 'rgba(255, 255, 128, 0.4)']
      }
    },
    series: [
      {
